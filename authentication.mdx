---
title: "Authentication: API Keys for Bunker Models"
sidebarTitle: "Authentication"
description: "Generate a Bunker API key, pass it as a bearer token on every request, and rotate it safely. Covers scopes, headers, and common auth errors."
---

Bunker authenticates every API call with a bearer token. You get one from your Bunker account and pass it in the `Authorization` header of each request.
...
<Note>
  All Bunker endpoints require authentication. Unauthenticated requests return `401 Unauthorized`.
</Note>
