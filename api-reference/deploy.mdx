---
title: "Deploy a Bunker Longevity Model Instance"
sidebarTitle: "Deploy a Model"
description: "Start a Bunker Longevity model instance so it accepts inference requests. Covers the deploy endpoint, instance types, status polling, and stopping instances."
---
