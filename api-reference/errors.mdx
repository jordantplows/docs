---
title: "Bunker API Errors: Codes, Meanings, and Fixes"
sidebarTitle: "Errors"
description: "Reference for every error the Bunker API can return. Each entry includes the HTTP status, error code, meaning, and the recommended way to recover."
---

The Bunker API returns errors as JSON with a stable `code` you can switch on and a human-readable `message`. HTTP status codes follow standard REST conventions.
